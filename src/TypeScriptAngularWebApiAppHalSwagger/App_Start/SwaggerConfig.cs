...
namespace TypeScriptAngularWebApiAppHalSwagger
{
    ...
    public static class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "TypeScriptAngularWebApiAppHalSwagger");
        ...
        {
            return string.Format(@"{0}\bin\TypeScriptAngularWebApiAppHalSwagger.XML", AppDomain.CurrentDomain.BaseDirectory);
        }
    }
}